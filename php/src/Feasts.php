...
/**
 * Feast registry — hand-maintained mirror of core/feasts.json.
 * Keep order + identifiers identical for cross-port test parity.
 */
final class Feasts
{
    ...
    public static function all(): array
    {
        return [
            ...
            ['id' => 'palm_sunday',  'names' => ['en' => 'Palm Sunday',          'ar' => 'أحد الشعانين'],        'type' => 'moveable', 'category' => 'major', 'easter_offset' => -7],
            ['id' => 'easter',       'names' => ['en' => 'Easter Sunday',        'ar' => 'عيد القيامة المجيد'], 'type' => 'moveable', 'category' => 'major', 'easter_offset' => 0],
            ['id' => 'ascension',    'names' => ['en' => 'Ascension',            'ar' => 'عيد الصعود'],          'type' => 'moveable', 'category' => 'major', 'easter_offset' => 39],
            ['id' => 'pentecost',    'names' => ['en' => 'Pentecost',            'ar' => 'عيد العنصرة'],         'type' => 'moveable', 'category' => 'major', 'easter_offset' => 49],
        ];
    }
}
